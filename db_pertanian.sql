...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 19 Jul 2021 pada 18.05
...
INSERT INTO `detail_transaksi` (`ID_Penjualan`, `Kode_Tanaman`, `ID_Distributor`, `ID_Admin`, `Jumlah`, `Harga`, `total`) VALUES
('1001', 50015, 10013, 1, 3, 5000, 15000),
('1002', 23432, 10013, 1, 3, 10000, 30000);
